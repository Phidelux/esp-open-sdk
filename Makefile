...
$(TOOLCHAIN)/xtensa-lx106-elf/usr/lib/liblwip_open.a: $(TOOLCHAIN)/bin/xtensa-lx106-elf-gcc
	...
	cp -a esp-open-lwip/include/arch esp-open-lwip/include/lwip \
		esp-open-lwip/include/netif esp-open-lwip/include/lwipopts.h \
		$(TOOLCHAIN)/xtensa-lx106-elf/usr/include/
	cp -a esp-open-lwip/include/arch esp-open-lwip/include/lwip \
		esp-open-lwip/include/netif esp-open-lwip/include/lwipopts.h \
		$(TOOLCHAIN)/xtensa-lx106-elf/sys-include/

libs: $(TOOLCHAIN)/xtensa-lx106-elf/usr/lib/libhal.a \
	$(TOOLCHAIN)/xtensa-lx106-elf/lib/libc.a.orig \
	$(TOOLCHAIN)/xtensa-lx106-elf/usr/lib/libcirom.a \
	$(TOOLCHAIN)/xtensa-lx106-elf/usr/lib/libmirom.a \
	$(TOOLCHAIN)/lib/gcc/xtensa-lx106-elf/$(GCC_VERSION)/libgcc.a.orig
